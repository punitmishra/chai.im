...
export class CryptoManager {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(CryptoManager.prototype);
        obj.__wbg_ptr = ptr;
        CryptoManagerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
    ...
    static fromBytes(data) {
        ...
        const ret = wasm.cryptomanager_fromBytes(ptr0, len0);
        if (ret[2]) {
    ...
    hasSession(peer_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_hasSession(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     * @param {string} peer_id
     * @param {Uint8Array} bundle_data
     * @returns {Uint8Array}
     */
    initSession(peer_id, bundle_data) {
        const ptr0 = passStringToWasm0(peer_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(bundle_data, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_initSession(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
     ...
     * @returns {Uint8Array}
     */
    exportSession(peer_id) {
        const ptr0 = passStringToWasm0(peer_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_exportSession(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    importSession(_peer_id, data) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_importSession(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
     ...
     */
    exportIdentity() {
        const ret = wasm.cryptomanager_exportIdentity(this.__wbg_ptr);
     ...
     */
    publicIdentity() {
        const ret = wasm.cryptomanager_publicIdentity(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    receiveSession(peer_id, initial_data) {
        const ptr0 = passStringToWasm0(peer_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(initial_data, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_receiveSession(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    generatePrekeyBundle() {
        const ret = wasm.cryptomanager_generatePrekeyBundle(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    generateOneTimePrekeys(count) {
        const ret = wasm.cryptomanager_generateOneTimePrekeys(this.__wbg_ptr, count);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    constructor() {
        const ret = wasm.cryptomanager_new();
    ...
    decrypt(peer_id, ciphertext) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_decrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    encrypt(peer_id, plaintext) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.cryptomanager_encrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('chai_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
