      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {results.length > 0 && (
          <div className="space-y-2">
            {/* Encryption info */}
            <div className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-green-500/5 border border-green-500/10 mb-4">
              <svg className="w-4 h-4 text-green-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
              </svg>
              <span className="text-xs text-green-400">All conversations are end-to-end encrypted using the Signal Protocol</span>
            </div>
            {results.map((user) => {
